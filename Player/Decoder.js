...
(function (root, factory) {
  ...
  var getModule = function(par_broadwayOnHeadersDecoded, par_broadwayOnPictureDecoded, wasmTextFile, wasmBinaryFile, asmjsCodeFile){
  ...
  var Decoder = function(parOptions){
    ...
    var onPicFun = function ($buffer, width, height, viewWidth, viewHeight) {
      ...
      if (this.options.rgb){
        ...
        this.onPictureDecoded(copyU8, width, height, viewWidth, viewHeight, infos);
        return;
      ...
      this.onPictureDecoded(buffer, width, height, viewWidth, viewHeight, infos);
    }.bind(this);
    
    var ignore = false;
    
    if (this.options.sliceMode){
      onPicFun = function ($buffer, width, height, viewWidth, viewHeight, $sliceInfo) {
        if (ignore){
          return;
        };
        var buffer = this.pictureBuffers[$buffer];
    ...
    var wasmTextFile = this.options.wasmTextFile;
    var wasmBinaryFile = this.options.wasmBinaryFile;
    var asmjsCodeFile = this.options.asmjsCodeFile;
    var ModuleCallback = getModule.apply(fakeWindow, [function () {
    }, onPicFun, wasmTextFile, wasmBinaryFile, asmjsCodeFile]);
    

    var MAX_STREAM_BUFFER_LENGTH = 1024 * 1024;
    
    var instance = this;
    this.onPictureDecoded = function (buffer, width, height, viewWidth, viewHeight, infos) {
      ...
      if (isWorker){
        ...
        if (e.data && e.data.type === "Broadway.js - Worker init"){
          ...
          if (e.data.options.sliceMode){
            ...
            decoder.onPictureDecoded = function (buffer, width, height, viewWidth, viewHeight, infos) {
